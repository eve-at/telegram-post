<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            ...
            <PrimaryButtonLink :href="route('videos.create')">Add new</PrimaryButtonLink>
        </template>
        ...
        <div class="mx-auto w-10/12 flex overflow-hidden flex-col">
            <div class="border bg-white border-gray-300 rounded-xl m-2 divide-y divide-solid overflow-hidden">
                <div v-if="!videos.data.length" class="p-3 italic">There is no videos so far</div>
                <div v-if="videos.data.length">
                    ...
                    >
                        ...
                        <div 
                            ...
                            v-text="formateDate(video.created_at)"                        
                        ></div>
