...
class MessageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($message->ad) {
            ...
            $message->ad_delete_at = $publishAt->clone()->addHours($data['ad_remove_after_hours']);
        }
    ...
    public function date(String $date)
    {
        ...
        return Message::select([
            ...
            ->map(function ($message) {
                ...
                $message['ad_delete_at'] = $message['ad_delete_at'] 
                    ? $this->dateToTimeString($message['ad_delete_at'])
